...
| **Email review** (10:00) | **Yes** — triage + judgment | `run-email-review.sh`: invokes a headless Alfred from the vault, points it at `AGENTS.md` + `persona/email-review.md`, runs `.bin/email-review --days 1 --record-ledger`, and sends only concrete questions or useful updates to Telegram. |
